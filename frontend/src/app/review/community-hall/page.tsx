              ...
              text={[
                ...
                <>
                  ...
                  <strong style={{ color: "#00a79d" }}>
                    แผนที่ชุมชนและเส้นทางการพัฒนาหมู่บ้าน
                  </strong>{" "}
                  ที่จะช่วยให้เราเรียนรู้เกี่ยวกับพื้นที่ที่เรากำลังศึกษา
                  ทั้งทรัพยากร โครงสร้างพื้นฐาน วิถีชีวิต
                  สถานที่สำคัญทางสุขภาพและโครงการพัฒนาต่างๆ
          ...
          <Tutorial
            text={[
              <>
                ...
                หากนักศึกษาพร้อมกันแล้ว ตามพี่พยาบาล
                <strong style={{ color: "#ff2020" }}>แกละ</strong>
                เข้ามาในศาลากลางบ้านกันได้เลยนะคะ
              </>,
            ]}
